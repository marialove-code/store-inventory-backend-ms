package com.inventory.modules.order.orderdelivery.mapper;
...
/**
* @author 95349
* @description 针对表【order_delivery】的数据库操作Mapper
* @createDate 2026-05-29 19:04:18
* @Entity com.inventory.modules.order.orderdelivery.entity.OrderDelivery
*/
