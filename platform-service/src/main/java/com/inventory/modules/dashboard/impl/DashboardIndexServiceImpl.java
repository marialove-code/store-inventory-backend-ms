 ...
 * 看板首页数据聚合。
 * <p>
 * <b>技术债（渐进拆分）：</b>本阶段仍同库只读 {@link OrderInfoMapper} + {@link InventoryStockMapper}
 * 做统计查询。后续应改为 OrderStatsClient / InventoryStockClient 等跨服务只读接口，
 * 去掉平台对订单表、库存表的直接 Mapper 依赖。
 * </p>
 */
@Service
